...
const arr1 = [23, 5, 6, 22, "a", true, 3, 5, 7, 3, "hello", "daniel"];
const arr2 = [3, 4, 5, 6, 0, 7];
const arr3 = [true, {}, []];

function question2_1(arr) {
...
function question2_2(arr) {
  console.log(arr.every((x) => Boolean(x)));
}
question2_2(arr1);
question2_2(arr2);
question2_2(arr3);
...
question2_4(arr3);
console.log(`______________________________________`);
function question2_5(arr) {
  console.log(arr.find((x) => x.length === 5));
}
question2_5(arr1);
question2_5(arr2);
question2_5(arr3);
console.log(`______________________________________`);
function question2_6(arr) {
...
question2_6(arr3);
console.log(`______________________________________`);
function question2_7(arr) {
  let filterArray = arr.filter((x) => typeof x === "number");
  console.log(filterArray.map((x) => x * 3));
}
question2_7(arr1);
question2_7(arr2);
question2_7(arr3);
...
function question3_1(arr) {
  arr.filter((x) => x.gender === "male").map((x) => x.gender);
}
question3_1(crazyList);
